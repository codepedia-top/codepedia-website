export const metadata = {
  title: "آیا می‌توان کاری کرد که کد سریع‌تر اجرا شود؟",
  description:
    "یکی از چالش‌هایی که هر برنامه‌نویس با آن روبه‌رو است، بهبود زمان اجرای کد و افزایش کارایی برنامه‌هاست. در این مقاله با بررسی یک الگوریتم مرتب‌سازی در زبان C، تکنیک‌هایی را برای بهینه‌سازی عملکرد و افزایش سرعت اجرای کد مرور می‌کنیم.",
  author: "Mahdi Rezaii",
  publishedAt: "2026-06-25",
  updatedAt: "2026-06-25",
  image:
    "https://res.cloudinary.com/defb3hycr/image/upload/v1782216556/photo-1484417894907-623942c8ee29_yrpyfc.avif",
  tags: ["algorithm", "c", "performance"],
  readingTime: 7,
  featured: true,
  draft: false,
};
